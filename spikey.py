...
f3 = 'data/alphabet_04_10'
f4 = 'data/alphabet_04_10_logkeys'
f5 = 'data/alphabet_4_10_2'
f6 = 'data/alphabet_4_10_2_logkeys'
f7 = 'data/alphabet_04_12'
f8 = 'data/alphabet_04_12_logkeys'
f9 = 'data/spaces_04_24'
f10 = 'data/spaces_04_24_logkeys'
...
# create model
model = None
# model = load_model('best_model.48-0.17.h5')
if model is None:
...
for k in range(y_test.size):
    ...
    if(max(y_pred_train[k]) == y_pred_train[k][4]):
        if(y_test[k] == 4):
            ...
            wpi += 1
    if(max(y_pred_train[k]) == y_pred_train[k][5]):
        if(y_test[k] == 5):
            space += 1
        else: 
            wspace += 1
...
print("space: ", space)
print("false space: ",wspace)
print("space not detected: ", mspace)
